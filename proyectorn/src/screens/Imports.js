  ...
  render (){
    return (
          <View style={importsStyle.container}>
              ...
              <TextInput style={importsStyle.input} keyboardType={"numbers-and-punctuation"} onChangeText={ value => this.setState({pedido: value})} placeholder="Cantidad de contactos..." ></TextInput>
